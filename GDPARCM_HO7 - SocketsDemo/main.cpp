...
// TODO:: comment the pragma out, if vcpkg is being used.
...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(UIManager::WINDOW_WIDTH, UIManager::WINDOW_HEIGHT, "Socket Chat System", nullptr, nullptr);
    if (window == nullptr)
        return 1;
