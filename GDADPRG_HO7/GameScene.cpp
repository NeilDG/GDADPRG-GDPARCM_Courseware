...
void GameScene::onLoadObjects()
{
	...
	EmptyGameObject* poolHolder = new EmptyGameObject("ProjectilePoolHolder");
	ProjectileHandler* projectileHandler = new ProjectileHandler(10, "projectile_handler");
	poolHolder->attachComponent(projectileHandler);
	this->registerObject(poolHolder);
