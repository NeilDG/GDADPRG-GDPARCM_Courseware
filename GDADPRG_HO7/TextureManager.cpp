...
void TextureManager::loadAll() {
	...
	texture = new sf::Texture();
	texture->loadFromFile("Media/Textures/Avenger.png");
	this->textureMap[Avenger].push_back(texture);

	texture = new sf::Texture();
	texture->loadFromFile("Media/Textures/TitleScreenBG.png");
	this->textureMap[MAIN_MENU_BG].push_back(texture);

	//projectile proper
	texture = new sf::Texture();
	texture->loadFromFile("Media/Textures/Pure_06.png");
	this->textureMap[PROJECTILE].push_back(texture);

	texture = new sf::Texture();
	texture->loadFromFile("Media/Textures/Pure_07.png");
	this->textureMap[PROJECTILE].push_back(texture);

	texture = new sf::Texture();
	texture->loadFromFile("Media/Textures/Pure_08.png");
	this->textureMap[PROJECTILE].push_back(texture);

	texture = new sf::Texture();
	texture->loadFromFile("Media/Textures/Pure_09.png");
	this->textureMap[PROJECTILE].push_back(texture);

	texture = new sf::Texture();
	texture->loadFromFile("Media/Textures/Pure_10.png");
	this->textureMap[PROJECTILE].push_back(texture);
}
